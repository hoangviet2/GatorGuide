...
export default function AuthPage() {
  const isDarkMode = false; // later you can switch this to useColorScheme() === "dark"
      ...
      <View className="w-full max-w-md">
        ...
        <View className={`${cardBgClass} border rounded-2xl p-6`}>
          ...
          <View className="gap-4">
            ...
            <Pressable onPress={handleSubmit} className="bg-green-500 rounded-lg py-4 items-center mt-2">
