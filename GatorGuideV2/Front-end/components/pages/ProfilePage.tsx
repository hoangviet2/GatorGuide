            ...
            <View className={`border-t ${borderClass} pt-4 mt-4`}>
              <View className="flex-row items-start">
                ...
                <View className="flex-1 ml-3">
                  ...
                  {isEditing ? (
                    <Pressable onPress={handlePickResume} className={`${inputBgClass} border rounded-lg px-3 py-3 flex-row items-center justify-between`}>
                    ...
                    <View className="flex-row items-center justify-between">
                      ...
                      {user.resume ? (
                        <Pressable onPress={() => {}}>
                          <Text className="text-green-500 text-sm">View</Text>
                        </Pressable>
                      ) : null}
                    </View>
                  )}
