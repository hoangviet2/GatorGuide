        ...
        <View className="flex-1 items-center justify-center px-6">
          <View className="w-full max-w-md">
            ...
            <View className={`${cardBgClass} border rounded-2xl p-6`}>
              <Text
                className={`text-sm ${secondaryTextClass} text-center`}
              >
        ...
        <View className="w-full max-w-md self-center">
          ...
          <View className={`${cardBgClass} border rounded-2xl p-6`}>
            <View className="gap-4">
              <View>
                <Text
                  className={`text-sm ${secondaryTextClass} mb-2`}
                >
                  Email Address
                </Text>
                <TextInput
              ...
              <Pressable
                ...
                className="w-full bg-green-500 rounded-lg py-4 items-center mt-2"
              >
